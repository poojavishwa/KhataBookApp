...
import { DeleteById, DeletePurcheseBillById } from "../Api/billCrud/BillCrud";
...
const PurcheseBillHeader: React.FC<HeaderProps> = ({title,billData}) => {
      ...
      const handleDelete = async () => {
        Alert.alert("Confirm", "Are you sure you want to delete this Bill?", [
          ...
          },
          {
            ...
            onPress: async () => {
              try {
                const result = await DeletePurcheseBillById(billData._id);
    ...
    return (
        <View style={styles.container}>
            ...
            onPress={() => navigation.navigate("Update Purchase Bill",{purcheseBillData:billData})}
            >
                <Image
...
export default PurcheseBillHeader;
