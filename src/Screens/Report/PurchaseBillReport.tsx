...
import { fetchPurchaseBillReport } from '../../Api/ReportApis/report';
...
const PurchaseBillReport = () => {
    ...
    useEffect(() => {
        const fetchInitialReports = async () => {
            ...
            const data = await fetchPurchaseBillReport(formattedStartDate,formattedEndDate);
            setReportData(data);
            setLoading(false);
        };
        fetchInitialReports();
        ...
        <View style={styles.container}>
            ...
            <View style={styles.dataSection}>
                ...
                <View style={styles.dataBox}>
                    ...
                    <Text style={[styles.dataValue, styles.green]}>₹ {reportData.netPurchaseValue}</Text>
                </View>
                <View style={styles.dataBox}>
            ...
            {loading ? (
                ...
                <FlatList
                    data={reportData.purchaseBills}
                    keyExtractor={(item, index) => item?._id?.toString() || index.toString()}
                    renderItem={({ item }) => (
                        <View style={styles.customerCard}>
                            <View>
                                <Text style={styles.customerName}>Purchase Bill</Text>
