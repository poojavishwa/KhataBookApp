  ...
  return (
    <View style={{ padding: 20 }}>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 10 }}>
        {/* Sale Bill Number */}
        <View>
          <Text style={{ fontSize: 16 }}>Purchese Number:</Text>
      ...
      <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 30, marginBottom: 30 }}>
        <Text style={{ fontSize: 16, fontWeight: "bold" }}>Purchese Amount:</Text>
...
export default CreatePacheseScreen;
