...
import { fetchQuotation } from "../../Api/billCrud/Quotation";
            ...
            >
              <View style={styles.customerCard}>
                <View>
                  ...
                  <Text style={styles.Invoice}>Sale Bill: #{item.QuotationNumber}</Text>
                  <Text style={styles.customerphone}>{item.customerId.phone}</Text>
                </View>
                <View>
                  <Text style={styles.customerName}>₹ {item.quotationAmount}</Text>
                  <Text
                    style={[
                      styles.customerName,
